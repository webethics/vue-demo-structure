<template>
    <b-row class="mrg-top">
        <div class="footer-content">
            <b-navbar-nav>
                <b-nav-item :to="'/home'" class="">
                    <span>
                        <font-awesome-icon icon="home" />
                    </span>
                    <p> Home </p>
                </b-nav-item>
                <b-nav-item :to="'/start'" class="main-btn">
                    <div class="gym-icon">
                ...
                <b-nav-item href="#" >
                  <ejs-dropdownbutton :items='items' @select="redirectTo($event)">
                      <span>
...
<script>
  ...
  import {faCoffee, faAngleDoubleRight, faHome, faBars, faEllipsisV} from '@fortawesome/free-solid-svg-icons'
  library.add(faCoffee, faAngleDoubleRight, faHome, faBars, faEllipsisV)
  export default {
    name: 'Footer',
    data () {
        return {
    ...
    methods: {
      redirectTo(event) {
         this.$router.push({ name: event.item.to }).catch(error => {});
      },
    },
  };
</script>
