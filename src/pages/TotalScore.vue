<template>
    <div class="main-wrapper black-cls">
        <b-container class="bv-example-row ">
            ...
            <b-row>
                <div class="tab-content lstep">
                    <b-tabs content-class="mt-3" align="center">
                        <b-tab title="Total Score" active>
                            <h1> Total Score</h1>
                            <span> 4.48 </span>
                        </b-tab>
                        <b-tab title="7 Day Avg">
                            <h1> 7 Day Avg </h1>
                            <span> 5 </span>
                        </b-tab>
                        <b-tab title="Today Score">
                            <h1> Today Score </h1>
                            <span> 10 </span>
                        </b-tab>
                        <b-tab title="Total Change">
                            <h1> Total Change</h1>
                            <span> 12 </span>
                        </b-tab>
                    </b-tabs>
            ...
            <b-row class="back-next-btn mg-t">
                <b-col >
                ...
                <b-col>
                    <router-link to="#app" class="btn btn-link">
                        Next
