    ...
    <div class="main-wrapper black-cls">
        <b-container class="bv-example-row ">
            ...
            <b-row>
                <div class="process">
                    <div class="svg-icon">
                        <img :src="height" class="height" />
                    </div>
                    <h2> What is your height?</h2>
                    <div class="incdecreanemt">
            ...
            <b-row class="back-next-btn">
                <b-col >
                    <router-link to="/process/birthday" class="btn btn-link ">
                        <font-awesome-icon icon="long-arrow-alt-left" />
                        Back
                    </router-link>
                </b-col>
                <b-col>
                    <router-link to="/total/score" class="btn btn-link">
                        Next
...
import height from './../../../../public/images/height.png';
