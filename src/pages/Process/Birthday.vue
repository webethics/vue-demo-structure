<template>
    <div class="main-wrapper black-cls">
        <b-container class="bv-example-row ">
            ...
            <b-row>
                <div class="process">
                    <div class="svg-icon">
                        <img :src="age" class="age" />
                    </div>
                    <h2> What is your birthday? </h2>
                    <b-form-group>
                        <b-form-datepicker class="ctm-select ctm-calndr"  id="datepicker-dateformat2" v-model="user.birthday" placeholder="22-2-1990" type="text" :date-format-options="{ year: 'numeric', month: 'numeric', day: 'numeric' }"></b-form-datepicker>
                    </b-form-group>
                </div>
            </b-row>
            <b-row class="back-next-btn">
                <b-col >
                ...
                <b-col>
                    <router-link to="/process/height" class="btn btn-link">
                        Next
